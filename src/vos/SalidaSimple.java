...
public class SalidaSimple {
	...
	public SalidaSimple(@JsonProperty(value="id") int id, @JsonProperty(value="tipoArribo") char tipoArribo, @JsonProperty(value="idAgente") int idAgente,
