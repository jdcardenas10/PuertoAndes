...
public class DAOTablaCobertizos {
	...
	public ArrayList<Cobertizo> darCobertizos() throws SQLException, Exception {
		ArrayList<Cobertizo> areas = new ArrayList<Cobertizo>();

		String sql = "select * from AREAS NATURAL JOIN COBERTIZOS";
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public Cobertizo buscarCobertizoPorID(int idn) throws SQLException, Exception {
		Cobertizo area=null;
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void addArea(Cobertizo area) throws SQLException, Exception {
	 ...
	 * @throws Exception - Cualquier error que no corresponda a la base de datos
	 */
	public void deleteArea(Cobertizo area) throws SQLException, Exception {
